---
title: "CRH Evaluation Brief FYTD2024"
date: "`r Sys.Date()`"
...
dates <- tibble(
  vssc_month = seq.Date(ymd("2023-10-01"), ymd("2024-06-01"), "1 month")) %>%
  arrange(vssc_month) %>%
...
* The data included here come from the first 9 months of FY24 (i.e., October 2023 - June 2024)
...
table_1 <- analytic_df %>%
  ...
  mutate(ctrl_gap_noCrh = replace_na(ctrl_gap_noCrh, 0)) %>%
  left_join(., analytic_df %>%
