...
# (590GB) Virginia Beach    
* [Located in Virginia Beach, VA](https://www.va.gov/find-locations/facility/vha_590GB)
* Open M-F, 8-4:30
...
#
adi_for_table <- adi %>% 
  filter(Sta5a == "590GB" & fy == 2020 & qtr == 1) %>%
...
```{r}
vssc_covariates %>% filter(sta5a == "590GB") %>%
  select(-sta5a) %>%
