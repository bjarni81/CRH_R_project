...
# (623GA) McAlester    
* [Located in McAlester, OK](https://www.va.gov/eastern-oklahoma-health-care/locations/mcalester-va-clinic/)
* Open M-F, 7-5:30
...
#
adi_for_table <- adi %>% 
  filter(Sta5a == "623GA" & fy == 2020 & qtr == 1) %>%
...
```{r}
vssc_covariates %>% filter(sta5a == "623GA") %>%
  select(-sta5a) %>%
