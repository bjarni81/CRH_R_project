...
### PC CRH Encounters - I    
```{r}
crh_plot_fxn_1(visn_var = 16, "Primary Care", "crh_encounters")
```

### PC CRH Encounters - II    
```{r}
crh_plot_fxn_2(visn_var = 16, "Primary Care", "crh_encounters")
```

### Total PC Encounters - I    
```{r}
crh_plot_fxn_1(visn_var = 16, "Primary Care", "total")
```
...
```{r}
crh_plot_fxn_1(visn_var = 16, "Primary Care", "crh_per_1k_total")
```

### PC CRH Encounters per 1,000 Total PC Encounters - II    
```{r}
crh_plot_fxn_2(visn_var = 16, "Primary Care", "crh_per_1k_total")
```

### As a Table  
```{r}
crh_table_fxn(visn_var = 16, "Primary Care")
```

## Primary Care Access Metrics  
### Established Patient Wait Time - I  
```{r}
access_plot_1(visn_var = 16, visn_var_quote = "16", established_pt_waitTime, "established_pt_waitTime")
```
  
### Established Patient Wait Time - II  
```{r}
access_plot_2(visn_var = 16, visn_var_quote = "16", established_pt_waitTime, "established_pt_waitTime")
```

### As a Table  
```{r}
access_table_fxn(visn_var = 16, "established_pt_waitTime")
```
 
### New Patient Wait Time - I  
```{r}
access_plot_1(visn_var = 16, visn_var_quote = "16", new_pt_waitTime, "new_pt_waitTime")
```
  
### New Patient Wait Time - II  
```{r}
access_plot_2(visn_var = 16, visn_var_quote = "16", new_pt_waitTime, "new_pt_waitTime")
```

### As a Table  
```{r}
access_table_fxn(visn_var = 16, "new_pt_waitTime")
```
 
### Observed:Expected Panel Size Ratio - I  
```{r}
access_plot_1(visn_var = 16, visn_var_quote = "16", obs_exp_panelSize_ratio, "obs_exp_panelSize_ratio")
```
  
### Observed:Expected Panel Size Ratio - II  
```{r}
access_plot_2(visn_var = 16, visn_var_quote = "16", obs_exp_panelSize_ratio, "obs_exp_panelSize_ratio")
```
 
### As a Table  
```{r}
access_table_fxn(visn_var = 16, "obs_exp_panelSize_ratio")
```

### Timely Care Success Rate - I  
```{r}
access_plot_1(visn_var = 16, visn_var_quote = "16", tc_pc_success_prop, "tc_pc_success_prop")
```
  
### Timely Care Success Rate - II  
```{r}
access_plot_2(visn_var = 16, visn_var_quote = "16", tc_pc_success_prop, "tc_pc_success_prop")
```

### As a Table  
```{r}
access_table_fxn(visn_var = 16, "tc_pc_success_prop")
``` 
...
```{r}
crh_plot_fxn_1(visn_var = 16, "Pharmacy", "crh_encounters")
```

### CPS CRH Encounters - II    
```{r}
crh_plot_fxn_2(visn_var = 16, "Pharmacy", "crh_encounters")
```

### Total CPS Encounters - I    
```{r}
crh_plot_fxn_1(visn_var = 16, "Pharmacy", "total")
```
...
```{r}
crh_plot_fxn_1(visn_var = 16, "Pharmacy", "crh_per_1k_total")
```

### CPS CRH Encounters per 1,000 Total CPS Encounters - II    
```{r}
crh_plot_fxn_2(visn_var = 16, "Pharmacy", "crh_per_1k_total")
```

### As a Table  
```{r}
crh_table_fxn(visn_var = 16, "Pharmacy")
```