...
# (531GH) Eastern Oregon    
* [Located in Hines, OR](https://www.va.gov/boise-health-care/locations/eastern-oregon-va-clinic/)
* Open M-F, 8-4:30
...
#
adi_for_table <- adi %>% 
  filter(Sta5a == "531GH" & fy == 2020 & qtr == 1) %>%
...
```{r}
vssc_covariates %>% filter(sta5a == "531GH") %>%
  select(-sta5a) %>%
