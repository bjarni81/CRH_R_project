...
# (554GG) La Junta    
* [Located in La Junta, CO](https://www.va.gov/eastern-colorado-health-care/locations/la-junta-va-clinic/)
* Open M-Th, 7-4:30
...
#
adi_for_table <- adi %>% 
  filter(Sta5a == "554GG" & fy == 2020 & qtr == 1) %>%
...
```{r}
vssc_covariates %>% filter(sta5a == "554GG") %>%
  select(-sta5a) %>%
