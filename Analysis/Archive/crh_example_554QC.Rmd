...
# (554QC) Salida    
* [Located in Salida, CO](https://www.va.gov/eastern-colorado-health-care/locations/salida-va-clinic/)
* Open M-Th, 8-4:30
...
#
adi_for_table <- adi %>% 
  filter(Sta5a == "554QC" & fy == 2020 & qtr == 1) %>%
...
```{r}
vssc_covariates %>% filter(sta5a == "554QC") %>%
  select(-sta5a) %>%
