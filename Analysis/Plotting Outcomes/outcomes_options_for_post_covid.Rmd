---
title: "When does \"post-COVID\" start II: testing different periods"
date: "`r Sys.Date()`"
...
* This a look at our outcomes over time, and comparing the pre-COVID study period to several potential "post-COVID" periods

## Decision Points  

* Per our meeting on January 25th 2023 I am presenting several options for a "post-COVID" period
...
#--
#--==========
fxn_plot_months <- function(outcome, month){
  period_date <- if(month == "July"){
    ymd("2020-08-01")
  }
  ...
  p1 <- ggplot(data = analytic_df,
    ...
    geom_smooth(data = subset(analytic_df, vssc_month < period_date
                              & vssc_month >= ymd("2020-03-01")),
                aes(x = vssc_month, y = {{outcome}}),
                method = "lm", se = F,
    ...
    scale_x_date(breaks = "6 months",
                 date_labels = "%m-%Y") +
    labs(y = "Days",
         title = paste0("March 2020 through ", month, " 2020")) +
...
## March through June  
```{r}
fxn_plot_months(est_pc_pt_wt, "June")
#
tab_model(fxn_lm(est_pc_pt_wt, "June"),
          dv.labels = "June")
```

## March through July  
```{r}
fxn_plot_months(est_pc_pt_wt, "July")
#
tab_model(fxn_lm(est_pc_pt_wt, "July"),
          dv.labels = "July")
```

## March through August  
```{r}
fxn_plot_months(est_pc_pt_wt, "August")
#
tab_model(fxn_lm(est_pc_pt_wt, "August"),
          dv.labels = "August")
```
...
```{r}
fxn_plot_months(est_pc_pt_wt, "September")
#
tab_model(fxn_lm(est_pc_pt_wt, "September"),
          dv.labels = "September")
```

## March through October  
```{r}
fxn_plot_months(est_pc_pt_wt, "October")
#
tab_model(fxn_lm(est_pc_pt_wt, "October"),
          dv.labels = "October")
```
...
## March through June  
```{r}
fxn_plot_months(new_pc_pt_wt, "June")
#
tab_model(fxn_lm(new_pc_pt_wt, "June"),
          dv.labels = "June")
```

## March through July  
```{r}
fxn_plot_months(new_pc_pt_wt, "July")
#
tab_model(fxn_lm(new_pc_pt_wt, "July"),
          dv.labels = "July")
```

## March through August  
```{r}
fxn_plot_months(new_pc_pt_wt, "August")
#
tab_model(fxn_lm(new_pc_pt_wt, "August"),
          dv.labels = "August")
```
...
## March through September  
```{r}
fxn_plot_months(new_pc_pt_wt, "September")
#
tab_model(fxn_lm(new_pc_pt_wt, "September"),
          dv.labels = "September")
```

## March through October  
```{r}
fxn_plot_months(new_pc_pt_wt, "October")
#
tab_model(fxn_lm(new_pc_pt_wt, "October"),
          dv.labels = "October")
```
...
## March through June  
```{r}
fxn_plot_months(third_next_avail, "June")
#
tab_model(fxn_lm(third_next_avail, "June"),
          dv.labels = "June")
```

## March through July  
```{r}
fxn_plot_months(third_next_avail, "July")
#
tab_model(fxn_lm(third_next_avail, "July"),
          dv.labels = "July")
```

## March through August  
```{r}
fxn_plot_months(third_next_avail, "August")
#
tab_model(fxn_lm(third_next_avail, "August"),
          dv.labels = "August")
```
...
## March through September  
```{r}
fxn_plot_months(third_next_avail, "September")
#
tab_model(fxn_lm(third_next_avail, "September"),
          dv.labels = "September")
```

## March through October  
```{r}
fxn_plot_months(third_next_avail, "October")
#
tab_model(fxn_lm(third_next_avail, "October"),
          dv.labels = "October")
```