---
title: "Post-COVID PC CRH Analysis: Stratified by CRH-Corrected Gap Metric"
date: "`r Sys.Date()`"
...
* This is the post-COVID analysis stratified by the sta5a-specific average gap metric over the 36 months of our study
* This version is using a __CRH-corrected__ version of the gap metric:
...
wbm_fxn <- function(outcome){
  ...
  fmla <- as.formula(paste0(outcome, " ~ treated_month + time_t ", 
                               " + adi_natRnk_avg + avg_age_oct1_2022 + nosos_risk_score",
                               "+ crh_corr_fte + pct_male + pct_white + pct_rural + scrssn_count_cat", 
                               "| treated_ever", 
                               " + adi_natRnk_avg + avg_age_oct1_2022 + nosos_risk_score",
                               "+ crh_corr_fte + pct_male + pct_white + pct_rural + s_abbr2 + scrssn_count_cat + parent_visn", 
