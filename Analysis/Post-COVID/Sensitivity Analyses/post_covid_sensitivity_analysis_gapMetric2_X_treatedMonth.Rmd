---
title: "Post-COVID PC CRH Analysis: Categorical Gap Metric X Treated Month"
date: "`r Sys.Date()`"
...
* This is a _post-COVID_ sensitivity analysis

## Decision Points  

* Per our discussion on June 25th we are looking at including an __interaction__ between time-varying meaningful use and time-varying gap metric
...
wbm_fxn <- function(outcome){
  ...
  fmla_gap_metric2 <- as.formula(paste0(outcome, " ~ treated_month + time_t ", 
                               ...
                               "+ gap_metric_cat + adi_natRnk_avg + avg_age_oct1_2022 + nosos_risk_score",
                               "+ crh_corr_fte + pct_male + pct_white + pct_rural + s_abbr2 + scrssn_count_cat + parent_visn", 
                               " | gap_metric_cat * treated_month + (1|sta5a)"))
  #
  mod_og <- 
  ...
  within_table <- within_og_sum %>%
    ...
    add_header_above(c(" ", "Original Analysis" = 2, "Interaction" = 2),
                     bold = T,
                     font_size = 18)
  #=======
