---
title: "Post-COVID PC CRH Analysis: Effect of Removing PCP/AP FTE & Gap Metric"
date: "`r Sys.Date()`"
...
* This is a sensitivity analysis examines the effect of removing __team PCP/APP FTE__ and the __gap metric__ from the models
