---
title: "Post-COVID PC CRH Analysis: CRH-Corrected FTE"
date: "`r Sys.Date()`"
...
* This is a sensitivity analysis examines the effect of using a __CRH-corrected FTE__
...
$$
\text{CRH-Corrected FTE}=\text{Total PCP/APP FTE}-\text{CRH PCP/APP FTE}
$$
