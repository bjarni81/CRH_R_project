...
plot_fxn(est_pc_pt_wt_pid, "est_pc_pt_wt_pid") + theme(legend.position = "right")
```
...
plot_fxn(new_pc_pt_wt_create, "new_pc_pt_wt_create") + theme(legend.position = "right")
```
...
plot_fxn(tna_new_source, "tna_new_source") + theme(legend.position = "right")
```
