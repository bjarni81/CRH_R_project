---
title: "D-i-D - Matched, no covariates"
date: "`r Sys.Date()`"
...
knitr::opts_chunk$set(warning = FALSE, message = FALSE, echo = FALSE, cache = FALSE, fig.width = 10, fig.height = 10)
#
...
* This is a __matched__ Difference-in-Differences analysis of 3 outcomes by whether or not the sta5a met our PC CRH inclusion criteria before March, 2020  
...
* This is analysis __1Aii__ from the Project Face Sheet
...
* Description of _Propensity Score_ matching
    + This analysis uses Propensity Score Matching model version 3.1
    + PS model 3.1 consisted of 
...
* The difference in differences is __-2.1 days__ (`r round(did_2, 4)`)  
...
* The difference in differences is __-4.6 days__ (`r round(did_2, 4)`)  
...
* The difference in differences is __-0.44 days__ (`r round(did_2, 4)`)  
