---
title: "CITS - pre-COVID, with Matching, some Covariates"
date: "`r Sys.Date()`"
...
* This is now the 2nd iteration of that analysis, where I'm only including the following covariates (in addition to treat, post, and treat X post):
