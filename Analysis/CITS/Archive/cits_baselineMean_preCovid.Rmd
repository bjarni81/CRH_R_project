---
title: "CITS - Baseline Mean Model"
date: "`r Sys.Date()`"
...
* This is now the 3rd iteration of that analysis, where I'm only including the following covariates (in addition to treat, post, and treat X post):
