---
title: "PC CRH - Pre-COVID Analysis, Zero CRH Among Controls"
date: "`r Sys.Date()`"
...
* This is a sensitivity analysis of the __Pre-COVID__ PC CRH analysis

## Decision Points  

* Per our discussion on 4/26 i ran propensity score matching model V5, but I restricted the pool of potential control sta5as to those that never had any PC CRH encounters
...
* Description of _Propensity Score_ matching
    + This report uses a variation of __Propensity Score v5.0__
