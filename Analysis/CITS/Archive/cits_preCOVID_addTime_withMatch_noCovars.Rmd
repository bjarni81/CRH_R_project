---
title: "CITS - pre-COVID, with time and Matching, no Covariates"
date: "`r Sys.Date()`"
...
* After out meeting on 12/21/2022 we decided that one of our next analyses is  a baseline linear trend model, which, in addition to an interaction between __treat__ and __post__, includes a __time__ term and and interaction between __time__ and __treat__:

$$y_{outcome}=\beta_{0} + \beta_{1}time_{t} +  \beta_{2}post_{t}+\beta_{3}treat_{j}+\beta_{4}time_{t}treat_{j}+\beta_{5}post_{t}treat_{j} +v_{j}+u_{jt}$$
...
* Description of analyses  
    + This analysis is a Comparative Interrupted Time Series 
