---
title: "CITS - Baseline Linear Trend Model"
date: "`r Sys.Date()`"
...
* During our meeting on 1/11/2023 we decided to move forward with a matched CITS analysis with covariates
* This is now the 2nd iteration of that analysis, where I'm only including the following covariates (in addition to treat, post, time, treat X post, and treat X time):
    + Obs:Exp panel size ratio
    + % male
    + % rural
...
analytic_df %>% 
  ...
  summarise(mean_val = mean(value, na.rm = T),
            ...
            qtl_25 = quantile(value, probs = 0.25),
            qtl_75 = quantile(value, probs = 0.75)) %>%
  mutate(
    name2 = case_when(
