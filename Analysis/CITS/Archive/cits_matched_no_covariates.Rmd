---
title: "CITS - Matched, No covariates"
date: "`r Sys.Date()`"
...
* This report describes a Comparative Interrupted Time-Series (CITS) analysis of outcomes over time
    + This analyses is the first in a series, and does not include any covariates 

## Decision Points  

* This is the first report generated after meeting on November 9th and getting the green light to move forward with our PS matching scheme (version 3.1)
