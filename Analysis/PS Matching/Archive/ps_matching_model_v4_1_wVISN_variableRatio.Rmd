---
title: "PS Matching Model v4.1 - With VISN, Variable Ratio"
date: "`r Sys.Date()`"
...
source(here("Input", "Analytic df", "F2_propensity_score_matching","propensity_score_matching_v4_wVISN_variableRatio.R"))
```
...
-   Using [Optimal Matching](https://cran.r-project.org/web/packages/MatchIt/vignettes/matching-methods.html#optimal-pair-matching-method-optimal) and a variable ratio of treated to controls we get `r sum(opt_matches_pcmm_noVISN == 1)` Treated units matched to `r sum(opt_matches_pcmm_noVISN == 0)` control units
