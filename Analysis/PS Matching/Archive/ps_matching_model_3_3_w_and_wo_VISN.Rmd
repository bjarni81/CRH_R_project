---
title: "PS Matching Model v3.3 - VISN vs. No VISN"
date: "`r Sys.Date()`"
...
#
source(here("Input", "Analytic df", "F2_propensity_score_matching","propensity_score_matching_v3_3_noVISN.R"))
```
...
## PS Match Model without VISN      

-   Using [Optimal Matching](https://cran.r-project.org/web/packages/MatchIt/vignettes/matching-methods.html#optimal-pair-matching-method-optimal) we get `r nrow(opt_matches_pcmm_noVISN) / 2` pairs\
...
```{r}
#=======
ggplot(data = ps_plot_df_pcmm_noVISN,
       aes(x = abs_smd, y = covar_lab, group = name_lab, fill = name_lab)) +
  geom_point(size = 2.25,
             shape = 21) +
  scale_fill_manual(values = c(
