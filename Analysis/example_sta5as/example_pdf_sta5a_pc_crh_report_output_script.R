...
render_sta5a_report_fxn <- function(sta5a){
  ...
  #-----
  rmarkdown::render(
    here("Analysis", "example_sta5as", "example_pdf_sta5a_pc_crh_report_template.Rmd"),
    params = list(
      sta5a_param = sta5a
    ),
    output_dir = here("Analysis", "example_sta5as", "Reports", "pdf"),
    output_file = paste0("V", visn_of_sta5a, "_", sta5a, "_pc_crh_report.pdf")
  )
}
#======================================================================•
