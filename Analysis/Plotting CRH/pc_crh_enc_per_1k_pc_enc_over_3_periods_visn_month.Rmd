...
* These data include the `r nrow(months_in_crh)` months from `r month.name[month(min(crh_encounters_visn_month$crh_month))]`, `r year(min(crh_encounters_visn_month$crh_month)) %>% as.numeric` through `r month.name[month(max(crh_encounters_visn_month$crh_month))]`, `r year(max(crh_encounters_visn_month$crh_month)) %>% as.numeric` (inclusive)
