...
--
select sta5a
	, cast('2018-09-01' as date) as month_for_joining
into #sta5as_join_dates
from [OABI_MyVAAccess].[crh_eval].C2_vast_from_a06
UNION
select sta5a
	, cast('2018-08-01' as date) as month_for_joining
from [OABI_MyVAAccess].[crh_eval].C2_vast_from_a06
UNION
select sta5a
	, cast('2018-07-01' as date) as month_for_joining
from [OABI_MyVAAccess].[crh_eval].C2_vast_from_a06
order by sta5a;
--3,813
/*=====================================================*/
-- Average by sta5a and output permanent table
drop table if exists [OABI_MyVAAccess].[crh_eval].F1_3_vssc_3mo_avg;
--
with cte as(
...
into [OABI_MyVAAccess].[crh_eval].F1_3_vssc_3mo_avg
from cte
group by sta5a
--1,085
select top 100 * from [OABI_MyVAAccess].[crh_eval].F1_3_vssc_3mo_avg