/*
3 month average of outcomes for PS matching: July, August, September of 2018
*/
...
where vssc_month > cast('2018-06-01' as date)
	and vssc_month < cast('2018-10-01' as date)
group by sta5a;
--1,228
...
where viz_month > cast('2018-06-01' as date)
	and viz_month < cast('2018-10-01' as date)
group by req_sta5a;
--1,033
select sta5a 
into #sta5as
...
drop table if exists [OABI_MyVAAccess].[crh_eval].F3_access_metrics_3mo_avg;
--
select a.sta5a
	, b.est_pc_pt_wt_avg, b.new_pc_pt_wt_avg, b.third_next_avail_avg
	, c.tc_success_prop_avg, c.tc_pc_success_prop_avg
into [OABI_MyVAAccess].[crh_eval].F3_access_metrics_3mo_avg
from #sta5as as a
...
--
select top 100 *
from [OABI_MyVAAccess].[crh_eval].F3_access_metrics_3mo_avg