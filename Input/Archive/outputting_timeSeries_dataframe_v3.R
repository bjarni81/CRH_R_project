...
#-----------------=========================== CRH ENCOUNTERS
crh_encounters_1 <- dbGetQuery(oabi_con,#1,734,362
                               "select *
...
# PC Access Metrics
#---===---===---===---===
pc_access_metrics <- read_csv("H:/HSRD_General/Kaboli Access Team/CRH Evaluation/Bjarni/CRH_r_project/Input/Data/pc_access_metrics.csv")
#---===---===---===---===
...
write_csv(analytic_df,
          "H:/HSRD_General/Kaboli Access Team/CRH Evaluation/Bjarni/CRH_r_project/Output/Data/analytic_df_v3.csv")
